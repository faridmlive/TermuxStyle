# 🔥 TermuxStyle - 100 Styles Edition
...
git clone https://github.com/faridmlive/TermuxStyle
cd TermuxStyle
...
**No external dependencies required!** TermuxStyle uses only Python standard libraries. Just install Python and you're ready to go!
...
▸ Enter your name/handle: Farid_Mahamud
```
...
### Issue: Auto-Startup Not Working
...
For more screenshots and previews, check out:
...
🔗 **Repository:** [https://github.com/faridmlive/TermuxStyle](https://github.com/faridmlive/TermuxStyle)

```bash
# Share with friends
echo "Check out TermuxStyle!"
```
